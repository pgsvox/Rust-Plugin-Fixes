...
{
    [Info("Backpacks", "LaserHydra", "2.1.9", ResourceId = 1408)]
    ...
    internal class Backpacks : RustPlugin
    {
        ...
        private class Backpack
        {
            ...
            public StorageSize Size =>
                _instance.permission.UserHasPermission(ownerID.ToString(), "backpacks.use.xlarge") ? StorageSize.XLarge :
        ...
        public static string GetContainerPrefab(StorageSize size)
        {
            switch (size)
            {
                case StorageSize.XLarge:
                    return "assets/prefabs/misc/halloween/coffin/coffinstorage.prefab";
        ...
        {
            Configuration.BackpackSizeInt = GetConfig(Configuration.BackpackSizeInt, "Backpack Size (1-4)");
