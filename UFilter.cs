...
namespace Oxide.Plugins
{
    ...
    class UFilter : CovalencePlugin
    {
        ...
        protected override void LoadDefaultConfig()
        {
            ...
            Config["chat colour players"] = player_colour = GetConfig("chat colour players", "#81daf5");
            Config["chat colour mods"] = mod_colour = GetConfig("chat colour mods", "#3349f4");
            Config["chat colour admins"] = admin_colour = GetConfig("chat colour admins", "#11f752");
        ...
        #endregion
        private string UserNameColour(BasePlayer player)
        {
            string colour = player_colour;
        ...
        object OnUserChat(IPlayer player, string message)
        {
            ...
            if (BetterChat) 
			{
				message = (string)BetterChat.Call("API_GetFormattedMessage", player, processed);
			}
			else
			{
				message = "<color=" + UserNameColour(basePlayer) + ">" + basePlayer.displayName + "</color>: "  + message;
			}
