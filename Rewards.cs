...
namespace Oxide.Plugins
{
	...
	public class Rewards : RustPlugin
	{
		...
		readonly DynamicConfigFile dataFile = Interface.Oxide.DataFileSystem.GetFile("RewardsMsg");
		...
		private void SetDefaultConfigValues()
		{
			...
			o = new Options
			{
				...
				UseClansPlugin = true,
				Economics_TakeMoneyFromVictim = true,
		...
		private void MessagePlayer(BasePlayer player, string msg, string prefix)
		{
			...
			if (player == null || msg == null || player.UserIDString == null) return;
		...
		private void OnEntityKill(BaseNetworkable entity)
		{
			...
			if (entity != null && entity.ShortPrefabName != null && entity.net.ID != null)
			{
				...
				if (key_found)
				{
					...
					catch {Puts("Tell Mals Error on OKE Try Get Value");}
					try
					{
						EntityCollectionCache.Remove(entity.net.ID);
					}
					catch {Puts("Tell Mals Error on OKE Remove");}
				}
			}
		}
