...
namespace Oxide.Plugins
{
    ...
    class GUIAnnouncements : RustPlugin
    {
        ...
        public bool bradleyDestroyedAnnouncement { get; private set; } = true;
        public bool bradleyDestroyedAnnouncementWithDestroyer { get; private set; } = true;
        public string bradleySpawnAnnouncementText { get; private set; } = "Bradley is rolling!";
        public string bradleyDespawnAnnouncementText { get; private set; } = "The Bradley has left.";
        public string bradleyDestroyedAnnouncementText { get; private set; } = "The Bradley has been taken down!";
        public string bradleyDestroyedAnnouncementWithDestroyerText { get; private set; } = "{playername} got the last shot on the Bradley taking it down!";
        public string bradleySpawnAnnouncementBannerColor { get; private set; } = "Red";
        public string bradleySpawnAnnouncementTextColor { get; private set; } = "Orange";
        public string bradleyDestroyedAnnouncementBannerColor { get; private set; } = "Red";
        public string bradleyDestroyedAnnouncementTextColor { get; private set; } = "White";
        ...
        private void LoadGUIAnnouncementsConfig()
        {
            ...
            bradleySpawnAnnouncementBannerColor = GetConfig("Public Bradley Announcements", "Spawn Banner Color", bradleySpawnAnnouncementBannerColor);
            ConvertBannerColor(bradleySpawnAnnouncementBannerColor, true);
            if (!ConvertedBannerColor)
            {
                ConvertedBannerColor = true;
                PrintWarning("\"Public Bradley Announcements - Spawn Banner Color: " + bradleySpawnAnnouncementBannerColor + "\" is not a valid color, resetting to default.");
                Config["Public Bradley Announcements", "Spawn Banner Color"] = "Red";
                ConfigUpdated = true;
            }
            bradleySpawnAnnouncementTextColor = GetConfig("Public Bradley Announcements", "Spawn Text Color", bradleySpawnAnnouncementTextColor);
            ConvertTextColor(bradleySpawnAnnouncementTextColor, true);
            if (!ConvertedTextColor)
            {
                ConvertedTextColor = true;
                PrintWarning("\"Public Bradley Announcements - Spawn Text Color: " + bradleySpawnAnnouncementTextColor + "\" is not a valid color, resetting to default.");
                Config["Public Bradley Announcements", "Spawn Text Color"] = "Orange";
                ConfigUpdated = true;
            }
            bradleyDespawnAnnouncement = GetConfig("Public Bradley Announcements", "Despawn", bradleyDespawnAnnouncement);
            bradleyDespawnAnnouncementText = GetConfig("Public Bradley Announcements", "Despawn Text", bradleyDespawnAnnouncementText);
            bradleyDespawnAnnouncementBannerColor = GetConfig("Public Bradley Announcements", "Despawn Banner Color", bradleyDespawnAnnouncementBannerColor);
            ConvertBannerColor(bradleyDespawnAnnouncementBannerColor, true);
            if (!ConvertedBannerColor)
            {
                ConvertedBannerColor = true;
                PrintWarning("\"Public Bradley Announcements - Despawn Banner Color: " + bradleyDespawnAnnouncementBannerColor + "\" is not a valid color, resetting to default.");
                Config["Public Bradley Announcements", "Despawn Banner Color"] = "Red";
                ConfigUpdated = true;
            }
            bradleyDespawnAnnouncementTextColor = GetConfig("Public Bradley Announcements", "Despawn Text Color", bradleyDespawnAnnouncementTextColor);
            ConvertTextColor(bradleyDespawnAnnouncementTextColor, true);
            if (!ConvertedTextColor)
            {
                ConvertedTextColor = true;
                PrintWarning("\"Public Bradley Announcements - Despawn Text Color: " + bradleyDespawnAnnouncementTextColor + "\" is not a valid color, resetting to default.");
                Config["Public Bradley Announcements", "Despawn Text Color"] = "White";
                ConfigUpdated = true;
            }
            bradleyDestroyedAnnouncement = GetConfig("Public Bradley Announcements", "Destroyed", true);
            bradleyDestroyedAnnouncementWithDestroyer = GetConfig("Public Bradley Announcements", "Show Destroyer", true);
            bradleyDestroyedAnnouncementText = GetConfig("Public Bradley Announcements", "Destroyed Text", bradleyDestroyedAnnouncementText);
            bradleyDestroyedAnnouncementWithDestroyerText = GetConfig("Public Bradley Announcements", "Destroyed Text With Destroyer", bradleyDestroyedAnnouncementWithDestroyerText);
            bradleyDestroyedAnnouncementBannerColor = GetConfig("Public Bradley Announcements", "Destroyed Banner Color", bradleyDestroyedAnnouncementBannerColor);
            ConvertBannerColor(bradleyDestroyedAnnouncementBannerColor, true);
            if (!ConvertedBannerColor)
            {
                ConvertedBannerColor = true;
                PrintWarning("\"Public Bradley Announcements - Destroyed Banner Color: " + bradleyDestroyedAnnouncementBannerColor + "\" is not a valid color, resetting to default.");
                Config["Public Bradley Announcements", "Destroyed Banner Color"] = "Red";
                ConfigUpdated = true;
            }
            bradleyDestroyedAnnouncementTextColor = GetConfig("Public Bradley Announcements", "Destroyed Text Color", bradleyDestroyedAnnouncementTextColor);
            ConvertTextColor(bradleyDestroyedAnnouncementTextColor, true);
            if (!ConvertedTextColor)
            {
                ConvertedTextColor = true;
                PrintWarning("\"Public Bradley Announcements - Destroyed Text Color: " + bradleyDestroyedAnnouncementTextColor + "\" is not a valid color, resetting to default.");
        ...
        void OnEntityKill(BaseNetworkable entity)
        {
            ...
            if (entity is BradleyAPC)
            {
                ...
                timer.Once(2, () =>
                {
                    if (BradleyNetIDs.Contains(entityNetID))
                        BradleyNetIDs.Remove(entityNetID);
